...
export default function ReviewList({ reviews }) {
            ...
            <div className="row justify-content-center mt-4">
                <div className="col-md-8 col-lg-6">
                    <div className="orange-box p-4">
                        <h5 className="section-heading mb-3 text-start">User Reviews</h5>
    ...
    return (
        <div className="row justify-content-center mt-4">
            <div className="col-md-8 col-lg-6">
                <div className="orange-box p-4">
                    <h5 className="section-heading mb-5">User Reviews</h5>
                        ...
                        <div key={index} className="individual-review p-3 mb-3 shadow-sm bg-white rounded">
                            <div className="d-flex justify-content-between align-items-center mb-2">
                                ...
                                {typeof review.starRating === 'number' && (
                                    <ul className="rate d-flex list-unstyled mb-0 review-stars">
                                        {[...Array(5)].map((_, i) => {
